...
vae.create_model(sigma0=sigma0, beta=beta, dense_act='tanh', conv_act=conv_act, pool=pool)
vae.add_loss_funcs()
vae.compile(learning_rate=learning_rate, optimizer='RMSprop')
vae.load()

vae.name += "_phase2"
vae.train(data, epochs=500, batch_size=10)
